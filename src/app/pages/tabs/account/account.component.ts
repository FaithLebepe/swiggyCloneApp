...
export class AccountComponent  implements OnInit {
  ...
  constructor() { 
    addIcons({ homeOutline, powerOutline, chevronForwardOutline, checkmarkCircleOutline });
  }
  ...
  getData() {
    ...
    setTimeout(() => {
      ...
      this.orders = [
        {
          address: {address: "Oudebrug, Potchefstroom, South Africa", house: "dsgd", id: "cLQdnS8YXk5HTDfM3UQC", landmark: "fdgs", lat: 26.108991978867923, lng: 91.79069981213378, title: "yui", user_id: "UA5JWxgjDOYgfXe92H0pFHwulTz2" }, 
          deliveryCharge: 20,
          grandTotal: "540.00",
          ...
          paid: "COD",  
          restaurant: {address: "Die Bult, Potch",  city: "909090567", closeTime: "21:00", cover: "", cuisines: ["Caribbean food", "North Indian", "Vietnamese"], delivery_time: 25, description: "dd", email: "DosaPlaza@gmail.com", latitude: 26.1286243, longitude: 91.8012675, id: "r5", isClose: true, name: "DosaPlaza", openTime: "07:00", phone: 6619563867, price: 27, rating: 4.7, short_name: "stayfit", status: "open", totalRating: 13},
          restaurant_id: "r5",  
          status: "created",
